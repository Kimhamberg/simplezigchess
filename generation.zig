...
fn getPawnMoves(self: *MoveGenerator, square: Square, piece: Piece) void {
    ...
    if (moveInBounds(oneStepSquare)) {
        ...
        if (oneStepMove.landingSquare == null and !movePutsYouInCheck(self, oneStepMove)) {
        ...
        if (moveInBounds(twoStepSquare)) {
            ...
            if (twoStepMove.landingSquare == null and isStartingRow and !movePutsYouInCheck(self, twoStepMove)) {
        ...
        if (moveInBounds(diagonalLeftSquare)) {
            ...
            if (!movePutsYouInCheck(self, diagonalLeftMove)) {
        ...
        if (moveInBounds(diagonalRightSquare)) {
            ...
            if (!movePutsYouInCheck(self, diagonalRightMove)) {
